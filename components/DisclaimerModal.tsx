    ...
    >
      <div className="relative w-full max-w-lg bg-white border-4 border-black shadow-[8px_8px_0px_0px_#000] p-5 sm:p-6 space-y-4 font-sans text-black">
        ...
        <div className="space-y-3 font-mono text-xs text-neutral-800 leading-relaxed border-t-2 border-b-2 border-neutral-200 py-3">
          <p>
            Selamat datang di <strong>adiiportuner.amprem</strong>!
          </p>
          <div className="p-3 bg-neutral-50 border-2 border-black space-y-1.5">
            <span className="font-bold text-black uppercase text-[11px] block">
              Rekomendasi Saluran Resmi:
            </span>
            <p className="text-[11px] text-neutral-700 leading-normal">
              Sangat direkomendasikan untuk bergabung ke <strong>Saluran Resmi adiiportuner</strong> agar selalu mendapatkan update informasi terbaru, tips verifikasi, serta pengumuman resmi seputar layanan ini.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-2 pt-1 font-mono">
          <div className="flex flex-col sm:flex-row items-center gap-2">
            ...
            >
              ...
              <span>Gabung Saluran Resmi</span>
            </a>
